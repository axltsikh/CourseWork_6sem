...
class _MainPageState extends State<MainPage> {
  ...
  Color getWaveColorByPercents(CustomProject project){
    double subtask = getSubtaskPercentsForProgressBars(project);
    double time = getDaysPercentsForProgressBar(project);
    print(time);
    print(subtask);
    if(time >= 100 && subtask <100){
      print("firstred");
      return Colors.red.shade300;
    }else if(subtask>=100){
      print("firstgreen");
    ...
    var attitude = time/subtask;
    print(attitude);
    if(attitude.compareTo(0.7)<0){
      print("secondgreen");
      return Colors.green.shade300;
    }
    if(attitude.compareTo(1.3)>0){
      print("secondred");
      return Colors.red.shade300;
    }
    else{
